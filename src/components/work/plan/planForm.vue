<template>
    <div class="planForm">
        <ul>
            <li>
               <yan-input v-bind="info.planName" v-model="plan.planName" maxlength='50' :required="true"/> 
            </li>
            ...
            <li>
               <yan-input v-bind="info.address" v-model="plan.address" maxlength='30'/> 
            </li>
            ...
            <li>
                <yan-textarea v-bind="info.remark" v-model="plan.remark" maxlength='200'/>
            </li>
        </ul>
        <mt-datetime-picker
            :startDate="new Date()"
