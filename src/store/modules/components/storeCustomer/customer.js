...
const mutations = {
  setSort: (state, str) => {
    state.customerAjaxParams.sort = str
  },
  setKey: (state, str) => {
    state.customerAjaxParams.key = str
  },
  setStoreCustomerAjaxParams: (state, obj) => {
    state.customerAjaxParams = obj
  },
