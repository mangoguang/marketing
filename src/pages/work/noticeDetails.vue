  ...
  <div class="article paddingTop">
    ...
    <div class="titleBar">
      ...
      <div style="color:#909090;font-size:14px">
        ...
        <img src="../../assets/imgs/visit.png"
             alt=""
             class="img"
             v-if="articleDetails.throughput>=10000">
      </div>
    </div>
    <div class="content"
         v-html="myhtml"
...
export default {
  ...
  methods: {
    ...
    getNoticeDetail(id) {
      indexModel
        .getNoticedDetail({ id: id })
        .then(res => {
          console.log(res.data)
          this.articleDetails = res.data
          if (res.data.detail) {
            let temp = res.data.detail.replace(/\--/g, '+')
            temp = temp.replace(/\\/g, '')
            this.myhtml = Base64.decode(temp) // changeImgStyle(b64DecodeUnicode(temp))
