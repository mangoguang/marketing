...
<template>
  <ul class="audioTechnica paddingTop">
    ...
    <li class="barBox">
      ...
      <div v-show="!storeGetInTotalShow"
           :style="{height: `100vw`}"
           ref="storeGetInTotalContainer"></div>
    ...
    <li class="barBox">
      ...
      <div v-show="!perStoreGetInShow"
           ref="perStoreGetInContainer"></div>
    ...
    <li class="barBox">
      ...
      <div v-show="!achieveRatioTotalShow"
           :style="{height: `100vw`}"
           ref="achieveRatioTotalContainer"></div>
    ...
    <li class="barBox">
      ...
      <div v-show="!perAchieveRatioShow"
           ref="perAchieveRatioContainer"></div>
    ...
    <li class="barBox">
      ...
      <div v-show="!orderFormTotalShow"
           :style="{height: `100vw`}"
           ref="orderFormTotalContainer"></div>
    ...
    <li class="barBox">
      ...
      <div v-show="!perOrderFormShow"
           ref="perOrderFormContainer"></div>
...
export default {
  ...
  methods: {
    ...
    getStoreGetInTotalData(date, city, level) {
      ...
      let _this = this
      mango
        .getAjax('/v1/app/report/store/number/all', {
    ...
    getPerStoreGetInData(date, city, level) {
      ...
      let _this = this
      mango
        .getAjax('/v1/app/report/store/number', {
          tenantId: this.ajaxData.tenantId,
          date: date
        })
        .then(res => {
    ...
    getAchieveRatioTotalData(date, city, level) {
      ...
      let _this = this
      mango
        .getAjax('/v1/app/report/turnover/ratio', {
          tenantId: this.ajaxData.tenantId,
          date: date,
          cityLevel: level,
          // cityName: '苏州市'
    ...
    getPerAchieveRatioData(date, city, level) {
      ...
      let _this = this
      mango
        .getAjax('/v1/app/report/store/turnover/ratio', {
          tenantId: this.ajaxData.tenantId,
          date: date,
          cityLevel: level,
          // cityName: '苏州市'
    ...
    getOrderFormTotalData(date, city, level) {
      ...
      let _this = this
      mango
        .getAjax('/v1/app/report/guest/order', {
          tenantId: this.ajaxData.tenantId,
          date: date,
          cityLevel: level,
          // cityName: '苏州市'
    ...
    getPerOrderFormData(date, city, level) {
      ...
      let _this = this
      mango
        .getAjax('/v1/app/report/store/guest/order', {
          tenantId: this.ajaxData.tenantId,
          date: date,
          cityLevel: level,
          // cityName: '苏州市'
