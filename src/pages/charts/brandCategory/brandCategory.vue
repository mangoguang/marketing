...
export default {
  ...
  methods: {
    ...
    // 获取报表数据
    // getChartData(startDate, endDate, areaMsg, brand) {
    //   if (!startDate) {
    ...
    // getArea(val) {
    //   // console.log(val);
    //   if (localStorage.getItem("areaMsg")) {
    //     this.areaMsg = localStorage.getItem("areaMsg");
    //   } else {
    //     this.areaMsg = val;
    //   }
    //   this.getChartData(
